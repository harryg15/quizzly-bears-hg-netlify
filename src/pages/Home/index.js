                                        ...
                                        <div className='create-form-container'>
                                            ...
                                            <form onSubmit={handleFormSubmit}>
                                                ...
                                                >
                                                    ...
                                                    <input required label="Username" onChange={handleUserName} value={username} placeholder="Username" className="input-group-text border border-primary m-1 w-100" />
                                                ...
                                                transition={{
                                                    ...
                                                    <input required label="Game ID" onChange={handleLobbyCode} value={lobbyCode} placeholder="Room ID" className="input-group-text border border-primary m-1 w-100" />
